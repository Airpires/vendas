...
<body>
		...
		<?php if($resultsCarts) : ?>
			...
			<table class="table table-strip">
				...
				<tbody>
				  ...
				  /*ARRAY PARA EXIBIÇÃO DOS DADOS A SEREM GRAVADOS NO BANCO*/
			array_push(
			$_SESSION['dados'],
			array(
			'id' => $result['id'],
			...
			<button class="btn btn-primary" type="submit">Atualizar Carrinho</button>
				...
				<form action="finalizar.php" enctype="multipart/form-data" method="post">	
                   <button name="enviar" class="btn btn-primary  type="submit">Finalizar Compra</button>
                </form>
	...
	<form action="" method="post">	
                   ...
                   <button class="btn btn-primary type="submit">Pesquisar Endereço</button>
                </form>
